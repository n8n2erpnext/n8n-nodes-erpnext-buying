...
const buyingResources: INodePropertyOptions[] = [
	{ name: 'Supplier', value: 'supplier' },
	{ name: 'Supplier Quotation', value: 'supplierQuotation' },
	{ name: 'Request for Quotation', value: 'requestForQuotation' },
	{ name: 'Purchase Order', value: 'purchaseOrder' },
	{ name: 'Purchase Receipt', value: 'purchaseReceipt' },
...
export class ErpNextBuying implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'ERPNext Buying',
		name: 'erpNextBuying',
		icon: 'file:erpnext-buying.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["resource"] + ": " + $parameter["operation"]}}',
		description: 'Work with ERPNext/Frappe Buying v15-v16 documents and methods',
		defaults: {
			name: 'ERPNext Buying',
		},
		inputs: ['main'],
		...
		properties: [
			...
			},
			{
				...
				default: '[]',
				description:
					'Frappe filters JSON. Example: [["docstatus","=",1]] or {"supplier":"Supplier Name"}.',
				displayOptions: {
					show: {
						operation: ['getMany'],
					},
